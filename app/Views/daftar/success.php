            ...
            <div class="text-center">
                ...
                <div class="mt-6 bg-blue-50 border border-blue-200 rounded-md p-4">
                    ...
                    <ul class="text-sm text-blue-700 space-y-1">
                        ...
                        <li>• Setelah disetujui, Anda akan mendapat ID Card</li>
                        <li>• Ikuti kegiatan orientasi yang akan dijadwalkan</li>
                    </ul>
                </div>
                
                <div class="mt-6 bg-yellow-50 border border-yellow-200 rounded-md p-4">
                    <h4 class="text-sm font-medium text-yellow-800 mb-2">Dokumen yang Akan Anda Terima:</h4>
                    <ul class="text-sm text-yellow-700 space-y-1">
                        <li>• Formulir Pendaftaran (PDF)</li>
                        <li>• ID Card MAPALA (PDF)</li>
                        <li>• Link Grup WhatsApp</li>
                    </ul>
                </div>
                ...
                <div class="mt-6 space-y-3">
                    ...
                    <a href="/divisi" class="w-full flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm text-sm font-medium text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Lihat Divisi MAPALA
                    </a>
                </div>
            </div>

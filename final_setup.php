...
// Script setup final untuk MAPALA Politala dengan MySQL
// Menangani semua setup dalam satu script

echo "🚀 Final Setup MAPALA Politala (MySQL)\n";
echo "======================================\n\n";
...
try {
    ...
    echo "🗑️  Database lama dihapus (jika ada)\n";
} catch (PDOException $e) {
...
echo "\n📚 Dokumentasi: README_MYSQL_SETUP.md\n";